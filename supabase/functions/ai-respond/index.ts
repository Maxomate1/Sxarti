...
- ოპერატორთან გადამისამართე მხოლოდ იმ შემთხვევაში, თუ მომხმარებელს აქვს ტექნიკური პრობლემა, საჩივარი, ან კითხვა რომელიც საერთოდ არ ეხება პროდუქციას და მომსახურებას. შეძენასთან, ფასებთან, მიტანასთან ან პროდუქტებთან დაკავშირებული ნებისმიერი კითხვა შენ თავად უნდა დაამუშავო${customKnowledge}${(() => {
